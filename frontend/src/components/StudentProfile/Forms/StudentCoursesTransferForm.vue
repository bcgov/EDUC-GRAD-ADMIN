                ...
                >
                  <v-expansion-panels multiple>
                    <v-expansion-panel
                      v-for="(
                        course, index
                      ) in transferStudentCourseResultsMessages"
                      :key="index"
                      elevation="0"
                      rounded="0"
                            ...
                            <span class="text-caption text-grey-darken-1">
                              {{
                                (() => {
                                  ...
                                  const warnings =
                                    course.validationIssues.filter(
                                      (i) =>
                  ...
                  <v-alert
                    v-if="coursesToTransfer.length > 0"
                    type="info"
                    class="mb-4"
                    border="start"
                    elevation="2"
                  ...
                  >
                    ...
                    <v-row
                      no-gutters
                      v-for="course in coursesToTransfer"
...
export default {
  ...
  methods: {
    ...
    async submitForm() {
      ...
      const courseWithoutCourseDetailsAndUserInfo = this.coursesToTransfer.map(
        ({
          courseDetails,
      ...
      const transferStudentCoursesRequestBody = toRaw(
        courseWithoutCourseDetailsAndUserInfo
      );
      try {
        await this.transferStudentCourses(
          this.sourceStudentData.studentID,
          this.targetStudentData.studentID,
          transferStudentCoursesRequestBody
        ).then((response) => {
