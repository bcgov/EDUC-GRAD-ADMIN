                ...
                v-model="isAddressFormValid">
                  ...
                  <v-row no-gutters>
                    <v-col cols="4">
                        <v-text-field 
                         id="mailAddressLine1" 
                          v-model="studentAddressCopy.addressLine1" 
                          variant="underlined"
                  ...
                  >
                    <v-col cols="4">
                      <v-text-field
                        id="addressLine2"
                        v-model="studentAddressCopy.addressLine2"
                        variant="underlined"
                  ...
                  >
                    <v-col cols="4">
                      <v-text-field
                        id="city"
                        v-model="studentAddressCopy.city"
                        variant="underlined"
                        label="City"
                        :rules="[requiredRule]"
                        :maxlength="255"
                 ...
                 <v-row
                  ...
                  >
                    ...
                    >
                      <v-select
                        id="country"
                        v-model="studentAddressCopy.countryCode"
                        :items="country"
                        item-title="label"
                  ...
                  <v-row
                    no-gutters
                    v-if="studentAddressCopy.countryCode ==='CN'"
                  >
                    <v-col
                      cols="4"
                      class="d-flex"
                    >
                      <v-select
                        id="province"
                        v-model="studentAddressCopy.provinceStateCode"
                        :items="province"
                        item-title="label"
                        variant="underlined"
                  ...
                  <v-row
                   ...
                   >
                    <v-col cols="4">
                      <v-text-field
                        id="postal"
                        v-model="studentAddressCopy.postalZip"
                        variant="underlined"
                        label="Postal/Zip"
