<template>
  ...
  <div class="col-12 px-3 py-3">
    <BlendingRules />
    <div
      class="col-12 px-3 py-3 float-right grad-actions"
      v-if="hasPermissions('STUDENT', 'updateCourseExam')"
    >
          ...
          <td :colspan="columns.length - 2">
            <v-row no-gutters>
              <v-col>
                ...
                <span
                  v-if="item.courseDetails.courseName"
            ...
            <v-row no-gutters>
              ...
              <v-col
                ...
                <span v-if="item.interimLetterGrade">{{
              ...
              <v-col
                ><strong>Eq/Ch&nbsp;</strong>
                <span v-if="item.equivOrChallenge">{{
