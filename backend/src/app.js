...
const studentCourseRouter = require("./routes/student-course-router");
const studentProgramRouter = require("./routes/student-program-router");
const studentOptionalProgramRouter = require("./routes/student-optional-program-router");
...
messagePubSub.init().then(() => {
  require('./messaging/handlers/grad-course-events-handler').subscribe();
}).catch((e) => log.error(e));
...
apiRouter.use("/student-course", studentCourseRouter);
apiRouter.use("/student-program", studentProgramRouter);
apiRouter.use("/student-optional-program", studentOptionalProgramRouter);
